...
- CSS is performant, but has global scope which results in spaghetti code. BEM is a naming convention that helps to avoid naming conflicts, but does not encapsulate styles.
