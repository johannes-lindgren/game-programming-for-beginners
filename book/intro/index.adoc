...
From the previous <<first-arrow-on-canvas, example with the arrow>>, moved the code that draws the shape to a reusable function, and use this function to draw three arrows of different sizes:
...
drawArrow(ctx, 125, 50, 50)
drawArrow(ctx, 100, 100, 100)
drawArrow(ctx, 50, 200, 200)
----
